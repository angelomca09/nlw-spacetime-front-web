  ...
  return (
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="relative flex flex-col items-start justify-between overflow-hidden border-r border-white/5 bg-[url(../assets/bg-stars.svg)] bg-cover px-28 py-16">
        {/* Blur */}
        <div className="rounded-ful absolute right-0 top-1/2 h-[288px] w-[526px] -translate-y-1/2 translate-x-1/2 rounded-full bg-purple-700 opacity-50 blur-full" />
        ...
        <div className="space-y-5">
          ...
          <a
            href=""
            className="upppercase inline-block rounded-full bg-green-500 px-5 py-3 font-alt text-sm leading-none text-black hover:bg-green-600"
          >
            CADASTRAR LEMBRANÇA
          </a>
        </div>
